    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> AddUser(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userManager.AddClaimAsync(user, new Claim(JwtClaimTypes.Name, model.Username));
                await _userManager.AddClaimAsync(user, new Claim(JwtClaimTypes.GivenName, model.FirstName));
                ...
                await _userManager.AddClaimAsync(user, new Claim(JwtClaimTypes.Scope, "api1"));
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user.IsEnabled && _userManager.CheckPasswordAsync(user, model.Password).GetAwaiter().GetResult())
                {
